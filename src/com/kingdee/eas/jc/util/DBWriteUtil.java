...
//	Connection conn = null;
	...
	private static DBWriteUtil dbcputils=null;  
    ...
    private DBWriteUtil(){  
        ...
        try {  
        	...
        	String driver = pu.getValue(Constants.WRITE_DRIVERCLASSNAME);
        	String dbSId = pu.getValue(Constants.WRITE_JDBC_URL);
        	String dbUser = pu.getValue(Constants.WRITE_JDBC_USERNAME);
        	String dbPasswd = pu.getValue(Constants.WRITE_JDBC_PASSWORD);
//		// 验证数据库地址和用户是否为空
...
//		}
    ...
    public synchronized static DBWriteUtil getInstance(){  
        if(dbcputils==null)  
            dbcputils=new DBWriteUtil();  
        return dbcputils;  
    }  
